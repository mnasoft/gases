...
(defclass <sp> nil
  ((sp-name
   ...
   (sp-comments :accessor sp-comments :initarg :comments :initform ""
                :documentation
   ...
   (sp-heat-formation
    :accessor sp-heat-formation :initarg
    :heat-formation :initform "" :documentation
...
(defclass <component> nil
  ((component-species
   ...
   (component-mole-fraction
    ...
    "Содежит мольную долю компонета."))
  (:documentation
