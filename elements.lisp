...
(progn
  ...
  (defparameter *Mcyclo_C5*    (make-instance 'molecule :molecule-name-en-short "Mcyclo_C5"    :molecule-μcp-a-b-c '(-7.701 125.675 -41.584  )  :molecule-mass 0.08416      :molecule-name-ru "Метил-Цикло-Пентан"  :molecule-formula "CH3-C5H9"   :molecule-note "принят по Циклогексану 84.16 (+ (* 12 6) 12)"))
  (defparameter *Mcyclo_C6*    (make-instance 'molecule :molecule-name-en-short "Mcyclo_C6"    :molecule-μcp-a-b-c '( -4.624 140.877 -46.698  ) :molecule-mass 0.09819      :molecule-name-ru "Метил-Цикло-Гексан"  :molecule-formula "CH3-C6H11"  :molecule-note "98.19 (+ (* 12 7) 14)"))
  )
